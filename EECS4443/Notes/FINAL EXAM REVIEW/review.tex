...
\end{itemize}
\newpage
\section*{Sample final exam solutions}
...
\begin{itemize}
    ...
    \item[2.] You are designing an assembly service for IKEA. The service allows users to input the pieces of furniture they want assembled and get a quote. The basic cost for any assembly is \$15 per item. Other factors include:
    \begin{itemize}
